...
export interface EnhancedAttendanceRecord extends AttendanceRecord {
  category: "Sunday" | "Midweek" | "Bible Study" | "Event" | "Small Group" | "Department";
  attendeeType: "Member" | "Visitor";
  attendeeId: string; // Links to Member or Visitor
  eventId?: string; // Optional link to specific event
}

export interface AttendanceAlert {
  id: string;
  type: "MissingMember" | "NewVisitor" | "Milestone";
  memberId?: string;
  visitorId?: string;
  message: string;
...
export interface EnhancedChurchEvent extends ChurchEvent {
...
export interface EventRegistration {
  ...
  ticketNumber: string;
  qrCode: string;
  status: "Registered" | "Waitlisted" | "CheckedIn" | "Cancelled";
}

export interface GroupEntity {
  id: string;
  type: "Ministry" | "Department" | "SmallGroup";
  name: string;
  description: string;
...
export interface VolunteerProfile {
  id: string; // Same as Member ID
  skills: string[];
  experience: string;
  availability: string;
  interests: string[];
  spiritualGifts: string[];
  preferredMinistryId?: string;

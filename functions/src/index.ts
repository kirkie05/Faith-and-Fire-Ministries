 ...
 */
export const onVisitorCreated = functions.firestore
 ...
 */
export const submitPrayerRequest = functions.https.onCall(async (data, context) => {
  if (!context.auth) {
    throw new functions.https.HttpsError("unauthenticated", "Authentication required.");
  }
 ...
 */
export const archiveSoftDeletedRecords = functions.pubsub

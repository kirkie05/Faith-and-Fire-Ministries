      ...
      >
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center relative bg-white overflow-y-auto">
          ...
          <div className="mb-8 flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#0A192F] to-[#ea580c] flex flex-col items-center justify-center shadow-lg">
              <span className="text-white font-black text-sm leading-none block">F&amp;</span>
              <span className="text-white font-black text-sm leading-none block mt-[-2px]">F</span>
            </div>
            <div>
              <span className="block font-sans font-extrabold text-sm uppercase tracking-tight text-[#0A192F]">FAITH &amp; FIRE</span>
              <span className="block text-[8px] font-sans font-bold text-neutral-400 uppercase tracking-widest">MINISTRIES</span>
            </div>
          </div>
        ...
        <div className="hidden md:flex w-1/2 bg-gradient-to-br from-[#1e1548] to-[#0A192F] relative p-12 flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10">
             <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 backdrop-blur-md mb-6">
                ...
                <span className="text-[10px] font-bold text-white uppercase tracking-widest">Faith &amp; Fire Ministries</span>
             </div>
...
const updatedCode = code.substring(0, returnStart) + newReturn + code.substring(returnEnd);
